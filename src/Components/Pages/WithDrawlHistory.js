...
export default function WithDrawlHistory(props) {
    ...
    async function withDrawlHistory() {
        const result = await apiCall('get', 'https://ylrwt.sse.codesandbox.io/transaction/withdrawlHistory');
        addCount(result);
        setData(result);
        ...
        swapPositions(column1, 2, 5);
        swapPositions(column1, 4, 6);
        setColumn(column1);
        setLoading(false);
    }
