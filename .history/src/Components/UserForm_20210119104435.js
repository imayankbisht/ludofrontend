...
export default function UserForm(props){
    ...
    return(
      <ThemeProvider theme={theme}>
            <Container style={{ backgroundColor: '#FFFFFF', height: '80vh' ,margin:'30px',border:'1px solid black' }} maxWidth="sm" className={classes.root}>
            <Typography component="div" style={{ backgroundColor: '#FFFFFF', height: '80vh' ,margin:'30px',border:'1px solid black' }}>
